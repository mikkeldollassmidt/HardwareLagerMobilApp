...
export const icons = {
  ...
  notifikation: (props) => <Octicons name="bell" size={26} {...props} />,
  qrscan: (props) => {
    ...
    return (
      <SvgUri
        uri={Asset.fromModule(iconUri).uri}
        width={30}
        height={30}
        {...props}
      />
  ...
  konto: (props) => <Feather name="user" size={26} {...props} />,
  mere: (props) => <SimpleLineIcons name="menu" size={26} {...props} />,
};
