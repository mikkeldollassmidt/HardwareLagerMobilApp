              ...
              onPress={() => {
                ...
                router.push({
                  ...
                  params: {
                    ...
                    imageUrl:
                      item.imageUrl || "https://via.placeholder.com/150", // Pass image URL
                    type: item.type || "Unknown Type", // Pass category
                    description: item.description || "No description available", // Pass description
                    category: JSON.stringify(item.hardwarecategories || []),
                  },
                });
              }}
            >
              <Product
                ...
                category={
                  Array.isArray(item.hardwarecategories)
                    ? item.hardwarecategories
                    : ["Unknown Category"]
                }
              />
            </TouchableOpacity>
